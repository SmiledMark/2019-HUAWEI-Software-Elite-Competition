...
#include <stdio.h>
#include <stdlib.h>
#define MAXCROSS 300//路口的最大数量
#define MAXCAR   60000//车的最大数量
#define MAXROAD  3000//道路的最大数量
#define OK 1
#define ERROR 0
#define TRUE 1
#define FALSE 0
...
{
	int  vex[MAXCROSS]; // 顶点表
	int  arc[MAXCROSS][MAXCROSS];//每条边上的权重，对于无权图来说可以用0，1来表示是否有由这两个节点相连的边
	int roadlen1[MAXCROSS+1][MAXCROSS+1]; //每条路的长度
	int verNum;//图中结点数
	int edgeNum;//边数
}MGraph;
//
...
/////////Int型矩阵空间(二维数组)动态分配//////////////////////
//extern int **matrixINT(int row, int column)
//{
//	int **m;
//	int i = 0;
