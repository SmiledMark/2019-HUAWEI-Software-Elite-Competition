...
class visualization(object):
    def __init__(self):
        ...
        self.savePath = 'D:\huawei2019-master(1)\picture'
        # ** cross param **#
        self.crossRadius = 14
...
def main():
    car_path = 'D:\huawei2019-master(1)\config_11\car.txt'
    road_path = 'D:\huawei2019-master(1)\config_11\\road.txt'
    cross_path = 'D:\huawei2019-master(1)\config_11\cross.txt'
    answer_path = 'D:\huawei2019-master(1)\config_11\\answer.txt'
    # ************************************* M A I N *******************************************#
    # load .txt files
